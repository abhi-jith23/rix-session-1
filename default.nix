# This file was generated by the {rix} R package v0.16.0 on 2025-09-15
# with following call:
# >rix(date = "2025-08-04",
#  > r_pkgs = c("dplyr",
#  > "ggplot2"),
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-08-04.tar.gz") { config.allowUnfree = true; };
